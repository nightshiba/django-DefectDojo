...
env = environ.Env(
    ...
    DD_SOCIAL_AUTH_SEZNAM_OAUTH2_ENABLED=(bool, False),
    DD_SOCIAL_AUTH_SEZNAM_OAUTH2_KEY=(str, ''),
    DD_SOCIAL_AUTH_SEZNAM_OAUTH2_SECRET=(str, ''),
    DD_SOCIAL_AUTH_SEZNAM_OAUTH2_DOMAIN=(str, ''),
    DD_SOCIAL_AUTH_SEZNAM_OAUTH2_API_URL=(str, ''),
    DD_SOCIAL_AUTH_SEZNAM_OAUTH2_AUTHORIZATION_URL=(str, ''),
    DD_SOCIAL_AUTH_SEZNAM_OAUTH2_ACCESS_TOKEN_URL=(str, ''),
    DD_SOCIAL_AUTH_SEZNAM_OAUTH2_SCOPE=(list, ['identity']),
    DD_SOCIAL_AUTH_SEZNAM_OAUTH2_IGNORE_DEFAULT_SCOPE=(str, ''),
    DD_SOCIAL_AUTH_SEZNAM_OAUTH2_ID_KEY=(str, ''),
...
SEZNAM_OAUTH_ENABLED = env('DD_SOCIAL_AUTH_SEZNAM_OAUTH2_ENABLED')
SOCIAL_AUTH_SEZNAM_OAUTH2_KEY = env('DD_SOCIAL_AUTH_SEZNAM_OAUTH2_KEY')
SOCIAL_AUTH_SEZNAM_OAUTH2_SECRET = env('DD_SOCIAL_AUTH_SEZNAM_OAUTH2_SECRET')
SOCIAL_AUTH_SEZNAM_OAUTH2_API_URL = env('DD_SOCIAL_AUTH_SEZNAM_OAUTH2_API_URL')
SOCIAL_AUTH_SEZNAM_OAUTH2_AUTHORIZATION_URL = env('DD_SOCIAL_AUTH_SEZNAM_OAUTH2_AUTHORIZATION_URL')
SOCIAL_AUTH_SEZNAM_OAUTH2_ACCESS_TOKEN_URL = env('DD_SOCIAL_AUTH_SEZNAM_OAUTH2_ACCESS_TOKEN_URL')
SOCIAL_AUTH_SEZNAM_OAUTH2_SCOPE = env('DD_SOCIAL_AUTH_SEZNAM_OAUTH2_SCOPE')
SOCIAL_AUTH_SEZNAM_OAUTH2_IGNORE_DEFAULT_SCOPE = env('DD_SOCIAL_AUTH_SEZNAM_OAUTH2_IGNORE_DEFAULT_SCOPE')
SOCIAL_AUTH_SEZNAM_OAUTH2_ID_KEY = env('DD_SOCIAL_AUTH_SEZNAM_OAUTH2_ID_KEY')
